#
# Be sure to run `pod lib lint DeclarativeEngine.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'DeclarativeEngine/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DeclarativeEngine' => ['DeclarativeEngine/Assets/*.png']
  # }

  s.public_header_files = 'DeclarativeEngine/Classes/**/*.h'
